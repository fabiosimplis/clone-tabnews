...
describe("PATCH  /api/v1/users/[username]", () => {
  ...
  describe("Default user", () => {
    ...
    test("With duplicated 'username'", async () => {
      ...
      const activateUser2 = await orchestrator.activateUser(createUser2);
      const sessionObject2 = await orchestrator.createSession(activateUser2.id);
    ...
    test("With duplicated 'email'", async () => {
      ...
      const activateUser = await orchestrator.activateUser(createdUser2);
      const sessionObject2 = await orchestrator.createSession(activateUser.id);
